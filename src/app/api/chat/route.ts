...
- 相关性判断要【准确】，不是【越窄越好】：一条热点，只要它的核心话题落在「${domain}」所属的【大类 / 行业 / 学科范围】之内——哪怕只是这个领域的某个细分方向、子行业、具体产品或前沿技术——就【算属于】该领域，【必须保留】。例如领域是「科技数码」，那么手机影像/摄影、芯片半导体、AI、生物科技、新能源车、航天、互联网大厂动态等【全都属于科技数码】；领域是「财经理财」，那么基建投资、宏观政策、行业财报等也都算。【严禁】以"虽然涉及科技/时政，但核心不在你的领域""不是最典型的那类话题"为由，把明明落在该领域大范围内的热点剔除掉——这是错误行为。
- 真正要剔除的，只有核心话题与「${domain}」【完全无关】的内容（例如领域「美食探店」里的选举/地缘政治/机器人）。判断标准是"核心话题是否落在这个领域的大范围内"，而【不是】"是不是这个领域最狭义、最典型的那几个话题"。遇到"沾边但确实属于该领域细分方向"的，一律【保留】；只有八竿子打不着的才丢弃。
