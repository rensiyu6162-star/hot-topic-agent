  ...
  const items = [
    ...
    isOpinion
      ? {
          id: "structure",
          q: shortForm
            ? "短档观点稿结构：亮主张 → 至少两层推进的论证 → 反方观点（允许只用一句话内嵌，如'你可以说…但…'）→ 反问/金句收尾，齐全即 Pass？"
            : "观点稿结构完整：立靶子（对立面怎么说）→ 层层递进的论证 → 反方最强观点及反驳 → 金句/反问收尾，可短但不许缺反方段？",
          passEg: shortForm
            ? "百字内能找到主张、推进论证、一句内嵌反方与回应、立场回扣"
            : "能找到靶子、至少两层推进论证、明确替反方说话再反驳、结尾有立场回扣",
          failEg: shortForm
            ? "只有主张没有论证、或完全没有反方视角的影子"
            : "只有自说自话没有反方、论证只有一层在原地重复、结尾口号化",
        }
      : {
          id: "structure",
    ...
    {
      id: "ending",
      q: "结尾：观点稿是不是金句回扣+贴着事件的具体反问；资讯稿是不是克制收束在事实/争议上，没有模板化互动乞讨？",
      passEg: "观点稿有二选一式具体反问；资讯稿停在真实悬念",
      failEg: "「你怎么看欢迎评论」「点赞关注不迷路」式万能尾巴",
    },
    {
      id: "fact-boundary",
      q:
